...
function fantasyMap() {
  ...
  function drawMonsters(){
    ...
    const trolls = terrain.select("#hills");
    const dragons = terrain.select("#dragons");
    const mermaids = terrain.select("#mermaids");
    ...
    //   }
    // }
    terrain.selectAll("g").selectAll("g").on("click", editMonsterIcon);
    console.timeEnd('drawMonsters');
  }

  function addMonsterIcon(height, type, cx, cy) {
